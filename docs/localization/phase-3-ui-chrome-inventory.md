...
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:1038` | `label` | Form |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:1041` | `label` | Import/Export |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:1754` | `label` | Copied! |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:1756` | `label` | Copy |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:1765` | `placeholder` | Paste exported teams, pokepaste URLs, or JSON here |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:1811` | `label` | Add Pok&eacute;mon |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:1826` | `label` | Close |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:1826` | `label` | Esc |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:1833` | `label` | Close |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:1833` | `label` | Esc |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:1841` | `label` | Close |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:1841` | `label` | Esc |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:2162` | `label` | Fetching Paste... |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:2175` | `label` | Paste copy here |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:2178` | `label` | Move here |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:2182` | `label` | Undo delete |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:2817` | `label` | Import |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:2859` | `label` | Import/Export |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:3118` | `label` | Import/Export Set |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:3123` | `label` | Copied! |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:3123` | `label` | Copy |
| `play.pokemonshowdown.com/src/battle-team-editor.tsx:3128` | `label` | Revert |
| `play.pokemonshowdown.com/src/panel-teambuilder.tsx:782` | `label` | Back |
| `play.pokemonshowdown.com/src/panel-teambuilder.tsx:785` | `label` | Save (not allowed for partial exports) |
| `play.pokemonshowdown.com/src/panel-teambuilder.tsx:788` | `label` | Save changes |
| `play.pokemonshowdown.com/src/panel-teambuilder.tsx:932` | `label` | Backup |
| `play.pokemonshowdown.com/src/panel-teambuilder.tsx:933` | `label` | folder |
| `play.pokemonshowdown.com/src/panel-teambuilder.tsx:933` | `label` | search results |
